...
if ($_SESSION["ID_login"] == 'แอดมิน') {
    ...
    include 'header/bareditpigmom_st.php';
} else {
    session_destroy();
    ...
    <div class="colorlib-narrow-content">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
                <h2 class="colorlib-heading">เพิ่มข้อมูลสุกรแม่พันธ์ุ</h2>
            </div>
        </div>
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingThree" style="border-radius: 20px">
                        <h4 class="panel-title">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseThree" style="border-radius: 20px">+เพิ่มข้อมูลสุกรแม่พันธ์ุ
                            </a>
                        </h4>
                    </div>
                    <div id="collapseThree" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingThree">
                        <div class="panel-body" style="border-radius: 20px">
                            <form action="" method="POST" name="bt1" style="width: 100%" id='addmom'>
                                <div class="panel-body" style="border-radius: 20px">
                                    <div class="col-md-12">
                                        <div class="col-md-4 form-group" align="center">
                                            <label>เบอร์หูสุกรแม่พันธู์ <a style="color: red;">&nbsp;&nbsp; *</a></label>
                                        ...
                                        <div class="col-md-4 form-group" align="center">
                                            <label>เบอร์หูพ่อของสกรุแม่พันธุ์ <a style="color: red;">&nbsp;&nbsp; *</a></label>
                                            <input class="form-control" name="det" id="det" onKeyUp="if(isNaN(this.value)){ alert('กรอกได้เฉพาะตัวเลขเท่านั้น'); this.value='';}" maxlength="4" minlength="4" type="text" style='height:40px; font-size:16px;'>
                                        </div>
                                        <div class="col-md-4 form-group" align="center">
                                        ...
                                        <div class="col-md-4 form-group" align="center">
                                            <label>เบอร์หูแม่ของสุกรแม่พันธุ์ <a style="color: red;">&nbsp;&nbsp; *</a></label>
                                            <input class="form-control" name="mom" id="mom" onKeyUp="if(isNaN(this.value)){ alert('กรอกได้เฉพาะตัวเลขเท่านั้น'); this.value='';}" maxlength="4" minlength="4" type="text" style='height:40px; font-size:16px;'>
                                        </div>
                                        <div class="col-md-4 form-group" align="center">
                                    ...
                                    <div align='center'>
                                        <input class="btn btn-primary btn-send-message" id="btnSend" style="border-radius: 10px; height:30px; width:79px; " type="button" value="ตกลง" onclick='inser_mom()'>
                                    </div>
                                </div>
                            </form>
                            <br>
...
<script type="text/javascript">
    ...
    function Saveedit($ID_breeder) {
        var numberedit = parseFloat(document.getElementById("numberedit" + $ID_breeder).value);
        var detedit = parseFloat(document.getElementById("detedit" + $ID_breeder).value);
        var selectAedit = document.getElementById("selectAedit" + $ID_breeder).value;
        var momedit = parseFloat(document.getElementById("momedit" + $ID_breeder).value);
        var datfromedit = document.getElementById("datfromedit" + $ID_breeder).value;
        var noedit = document.getElementById("noedit" + $ID_breeder).value;
        var datbirthedit = document.getElementById("datbirthedit" + $ID_breeder).value;
        ...
        if (String(num).length == "4") {
            if (String(num1).length == "4") {
                if (String(num2).length == "4") {
                    ...
                    alert("กรุณาใส่หมายเลขเบอร์หูแม่ของสุกรแม่พันธุ์ 4 หลัก");
                }
            } else {
                alert("กรุณาใส่หมายเลขเบอร์หูพ่อของสุกรแม่พันธุ์ 4 หลัก");
            }
        } else {
            alert("กรุณาใส่หมายเลขเบอร์หูสุกรแม่พันธุ์ 4 หลัก");
        }
    }
            ...
            if (String(num).length == "4") {
                if (num1 != "" && num1 != null) {
                    if (String(num1).length == "4") {
                                    ...
                                    if (String(num2).length == "4") {
                                        if (datfrom != "" && datfrom != null) {
                                            $.ajax({
                                                ...
                                                success: function(result) {
                                                    alert(result.message);
                                                    document.getElementById("addmom").reset();
                                                    window.location = 'addmom.php';
                                                }
                                            });
                                        } else {
                                        ...
                                        alert("กรุณาใส่หมายเลขเบอร์หูแม่ของสุกรแม่พันธู์ 4 หลัก");
                                    }
                                } else {
                                    alert("กรุณาใส่เบอร์หูแม่ของสุกรแม่พันธู์");
                                }
                            } else {
                        ...
                        alert("กรุณาใส่หมายเลขเบอร์หูพ่อของสุกรแม่พันธู์ 4 หลัก");
                    }
                } else {
                    alert("กรุณาใส่เบอร์หูพ่อของสุกรแม่พันธู์");
                }
            } else {
                alert("กรุณาใส่หมายเลขเบอร์หูสุกรแม่พันธุ์ 4 หลัก");
            }
        } else {
            alert("กรุณาใส่เบอร์หูสุกรแม่พันธู์");
        }
    }
