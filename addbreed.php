                            ...
                            <div class="panel-body" style="border-radius: 20px">
                                <div class="col-md-12">
                                    <div class="col-md-12 form-group" align="center">
                                        ...
                                        <input class="form-control" type="text" name="breed" id="breed" onKeyUp="if(!(isNaN(this.value))) { alert('กรุณากรอกอักษร'); this.value='';}" style='height:40px; font-size:16px;width: 30%;'>
                                    </div>
                                    <br>
                                </div>
                                <div align='center'>
...
<script type="text/javascript">
    ...
    function Saveedit($ID_breed) {
        var breededit = document.getElementById("breededit" + $ID_breed).value;
